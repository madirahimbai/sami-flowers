        ...
        <div className="hero-grid" style={{ gridTemplateColumns: '1fr' }}>
          <div className="hero-copy">
            ...
            <p className="lede">
              ...
              по Павлодару в течение 60 минут или самовывоз в день заказа. Перед отправкой присылаем фото букета в
              WhatsApp, чтобы вы видели именно то, что получит адресат.
            </p>

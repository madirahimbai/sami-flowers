...
export default function DeliveryPage() {
  ...
  return (
    <main className="info-page wrap">
      ...
      <p className="lede">
        Собираем букет и доставляем курьером по Павлодару в течение 60 минут — или отдаём на самовывоз в одном из
        двух магазинов. Перед отправкой присылаем фото готового букета в WhatsApp.
      </p>
      ...
      <p>
        Доставляем в течение 60 минут с момента подтверждения заказа. Работаем {WORKING_HOURS.toLowerCase()},
        точное время согласуем в переписке.
      </p>

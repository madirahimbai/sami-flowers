...
export default async function RosesPage() {
  ...
  return (
    <main className="info-page wrap">
      ...
      <p>
        Выберите букет, при необходимости — количество роз (например, 11, 25 или 51), и добавьте его в корзину.
        При оформлении укажите способ получения — самовывоз или доставку — и подтвердите заказ в WhatsApp.
        Подробные
